 ...
 */
public class TMKByICActivity extends BaseActivity {
    private static final String TAG = TMKByICActivity.class.getSimpleName();
...
//                }
        ...
        protected void onPostExecute(String s) {
            ...
            if (!TextUtils.isEmpty(s)) {
                ViewUtils.showToast(TMKByICActivity.this, s);
                activityStack.pop();
            } else {
                ViewUtils.showToast(TMKByICActivity.this, "密钥读取成功，请更换密钥卡！");
    ...
    class CheckICCardInPosition extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean b) {
            ...
            if (b) {
                ...
                ViewUtils.showToast(TMKByICActivity.this, "操作超时！");
                activityStack.pop();
            }
        }
    }
