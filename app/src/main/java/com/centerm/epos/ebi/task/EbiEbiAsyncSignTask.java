...
public class EbiEbiAsyncSignTask extends AsyncMultiRequestTask {

    private Map<String, Object> returnMap;

    public EbiEbiAsyncSignTask(Context context, Map<String, Object> dataMap, Map<String, Object> returnMap) {
        ...
        ResponseHandler handler = new ResponseHandler() {
            ...
            public void onSuccess(String statusCode, String msg, byte[] data) {
                ...
                if ("00".equals(respCode)) {
                    ...
                    if(!TextUtils.isEmpty(BusinessConfig.getInstance().getValue(context,TMK_KEY))){
                        String decodeTdk = SecurityTool.decrypt3DES(BusinessConfig.getInstance().getValue(context,TMK_KEY), tdkValue);
                        logger.error(BusinessConfig.getInstance().getValue(context,TMK_KEY));
                        logger.error(decodeTdk);
                        BusinessConfig.getInstance().setValue(context, TDK_KEY, decodeTdk);
                    }
