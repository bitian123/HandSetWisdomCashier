...
public class BaseField59 implements I8583Field {

    private static final String TAG = BaseField59.class.getSimpleName();
    //SM加密结果为16字节，32个字符
    ...
    public BaseField59(Map<String, Object> tradeInfo) {
    ...
    private String getVoucherNo(String fieldMsg) {
        if (TextUtils.isEmpty(fieldMsg))
            return null;
        if (fieldMsg.length() < 25)
            return null;
        return fieldMsg.substring(5, fieldMsg.length());
    }
