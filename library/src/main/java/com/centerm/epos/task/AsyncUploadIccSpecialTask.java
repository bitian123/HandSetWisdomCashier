...
/**
 * Created by zhouzhihua.
 */

public class AsyncUploadIccSpecialTask extends AsyncMultiRequestTask {
    ...
    public AsyncUploadIccSpecialTask(Context context, Map<String, Object> dataMap, List<TradeInfoRecord> tradeInfos) {
...
//        sleep(LONG_SLEEP);
    ...
    private void initData(TradeInfoRecord icCard) {
        ...
        * */
        ...
        dataMap.put(TradeInformationTag.CUSTOM_INFO_60, "00" + BusinessConfig.getInstance().getBatchNo(context) + iso60_3_NetManagerCode+"60");//60域
        String sAmt = getTransAmount(icCard.getAmount());
        sAmt = (sAmt==null) ? "000000000000" : sAmt;
        dataMap.put(TradeInformationTag.ORIGINAL_MESSAGE, "71"+(bIsCUPCard(icCard.getBankcardOganization()) ? "00" : "01")+"11"+ sAmt + "156"+"10");//62域用法七
