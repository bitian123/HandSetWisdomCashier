...
public class AsyncUploadIcDataTask extends AsyncMultiRequestTask {
    ...
    public AsyncUploadIcDataTask(Context context, Map<String, Object> dataMap, List<TradeInfoRecord> tradeInfos) {
...
//        sleep(LONG_SLEEP);
    ...
    private void initData(TradeInfoRecord icCard) {
        ...
        *IC卡批上送上送的60.3网络信息码对账平203，对账不平205
        * */
        String iso60_3_NetManagerCode = "203";
        if( !"1".equals(key_is_balance_settle) || !"1".equals(key_is_balance_settle_foreign)){
            iso60_3_NetManagerCode = "205";
        }
        ...
        * 修正62域数据 上送TC值的62域数据
        * */
        dataMap.put(TradeInformationTag.ORIGINAL_MESSAGE, "61"+(bIsCUPCard(icCard.getBankcardOganization()) ? "00" : "01")+"00" + sAmt + "156");//用法六
